...
`;le(Gs);Mn.render=Ws;Mn.__scopeId="data-v-82c27306";var zr=ce({props:{elevation:{type:Number,default:2}},setup(e){return{props:e}}});const qs=de(),Ys=qs((e,t,n,r,o,a)=>(B(),D("div",{class:["app-bar",[`elevation-${e.props.elevation}`,`elevation-background-${e.props.elevation}`]]},[Ne(e.$slots,"default")],2)));var Qs=`
.app-bar[data-v-2ddee2f9] {
    min-height: 4rem;
    display: flex;
    width: 100%;
}
`;le(Qs);zr.render=Ys;zr.__scopeId="data-v-2ddee2f9";var Nr=ce({components:{VmRipple:Vn},props:{type:{type:String,default:"button"},variant:{type:String,validator:e=>["contained","outlined","text"].includes(e),default:"contained"},routerPath:{type:String,default:""},isDisabled:{type:Boolean,default:!1},primaryColor:{type:String,default:"rgb(98, 0, 238)"},accentColor:{type:String,default:"rgb(255, 255, 255)"},elevation:{type:Number,default:2}},setup(e){const t=te(()=>{let n=`--primary-color: ${e.primaryColor};--text-color: ${e.accentColor};`;return e.elevation!==null&&(n+=`--default-elevation: var(--elevation-${e.elevation});--focus-elevation: var(--elevation-${e.elevation+2});--active-elevation: var(--elevation-${e.elevation+6});`),n});return{props:e,cssProperties:t}}});const qn=de();ye("data-v-9fecb26c");const Js=k("div",{class:"btn-overlay"},null,-1);_e();const Xs=qn((e,t,n,r,o,a)=>{const i=Zt("vm-ripple");return B(),D(Na(e.routerPath?"router-link":"button"),{class:["vm-btn",[`btn-${e.props.variant}`,{disabled:e.isDisabled}]],style:e.cssProperties,type:e.props.type,to:e.routerPath},{default:qn(()=>[Js,k(i,{rippleColor:e.props.variant!=="contained"?e.props.primaryColor:e.props.accentColor},{default:qn(()=>[Ne(e.$slots,"default")]),_:3},8,["rippleColor"])]),_:1},8,["class","style","type","to"])});var Zs=`
/* contained */
...
`;le(Zs);Nr.render=Xs;Nr.__scopeId="data-v-9fecb26c";var zn=ce({props:{elevation:{type:Number,default:2},borderRadius:{type:Number,default:5}},setup(e){const t=te(()=>`--card-border-radius: ${e.borderRadius}px;`);return{props:e,cssProperties:t}}});const ec=de(),tc=ec((e,t,n,r,o,a)=>(B(),D("div",{class:["card",[`elevation-${e.props.elevation}`,`elevation-background-${e.props.elevation}`]],style:e.cssProperties},[Ne(e.$slots,"default")],6)));var nc=`
...
`;le(nc);zn.render=tc;zn.__scopeId="data-v-114efd9e";var Fr=ce({setup(e){return{props:e}}});const rc=de();ye("data-v-e2fc2772");const oc={class:"card-content"};_e();const ac=rc((e,t,n,r,o,a)=>(B(),D("div",oc,[Ne(e.$slots,"default")])));var ic=`
.card-content[data-v-e2fc2772] {
    padding: 15px 20px;
}
`;le(ic);Fr.render=ac;Fr.__scopeId="data-v-e2fc2772";var Lr=ce({setup(e){return{props:e}}});const lc=de();ye("data-v-4bb1fe1a");const sc={class:"card-header"};_e();const cc=lc((e,t,n,r,o,a)=>(B(),D("div",sc,[Ne(e.$slots,"default")])));var dc=`
.card-header[data-v-4bb1fe1a] {
    padding: 15px 20px;
    font-size: 1.2rem;
    font-weight: 500;
}
`;le(dc);Lr.render=cc;Lr.__scopeId="data-v-4bb1fe1a";var jr=ce({setup(){return{}}});const uc=de();ye("data-v-bebb5804");const fc={class:"container"},pc={class:"content"};_e();const hc=uc((e,t,n,r,o,a)=>(B(),D("div",fc,[k("div",pc,[Ne(e.$slots,"default")])])));var vc=`
...
`;le(_c);Br.render=yc;Br.__scopeId="data-v-7427c44c";var Hr=ce({props:{spacing:{type:Number,default:50}},setup(e){return{cssProperties:te(()=>`--spacing: ${e.spacing}px;`)}}});const wc=de(),kc=wc((e,t,n,r,o,a)=>(B(),D("div",{class:"divider",style:e.cssProperties},null,4)));var $c=`
...
`;le(sd);Ur.render=ld;Ur.__scopeId="data-v-5a3bb4df";var Kr=ce({components:{VmActionButton:Mn,VmCard:zn},props:{title:{type:String,default:""},isPreventClose:{type:Boolean,default:!1}},setup(e){const t=Ke(!1);return{props:e,isVisible:t,show:()=>{t.value=!0},hide:()=>{e.isPreventClose||(t.value=!1)}}}});const Fo=de();ye("data-v-1b5e3877");const cd={class:"modal"},dd={class:"modal-content"};_e();const ud=Fo((e,t,n,r,o,a)=>{const i=Zt("vm-card");return B(),D(Yl,{to:"#app-theme"},[k("div",cd,[k(i,{class:["modal-pane",{"modal-visible":e.isVisible}],elevation:8},{default:Fo(()=>[k("div",dd,[Ne(e.$slots,"default")])]),_:3},8,["class"]),k("div",{class:["modal-background",{"modal-background-visible":e.isVisible}],onClick:t[1]||(t[1]=l=>e.hide())},null,2)])])});var fd=`
...
`;le(fd);Kr.render=ud;Kr.__scopeId="data-v-1b5e3877";var Wr=ce({props:{elevation:{type:Number,default:2}},setup(e){return{props:e}}});const pd=de(),hd=pd((e,t,n,r,o,a)=>(B(),D("div",{class:["navigation-drawer",[`elevation-${e.props.elevation}`,`elevation-background-${e.props.elevation}`]]},[Ne(e.$slots,"default")],2)));var vd=`
...
`;le(_d);Gr.render=yd;Gr.__scopeId="data-v-38e24d5a";var qr=ce({setup(){return{}}});const wd=de();ye("data-v-26a7c9a2");const kd={class:"page-header"};_e();const $d=wd((e,t,n,r,o,a)=>(B(),D("div",kd,[Ne(e.$slots,"default")])));var Ed=`
.page-header[data-v-26a7c9a2] {
    font-size: 2.2rem;
    margin-top: calc(var(--default-margin) * 4);
    margin-bottom: calc(var(--default-margin) * 6);
}
`;le(Ed);qr.render=$d;qr.__scopeId="data-v-26a7c9a2";var Yr={props:{id:{type:Number},modelValue:{type:Boolean,default:!1},label:{type:String}},setup(e,t){return{props:e,updateValue:r=>{t.emit("update:modelValue",r.target.checked)}}}};const Rd=de();ye("data-v-5779ef6a");const Cd={class:"switch-container"},Pd={class:"switch"},Sd=k("span",{class:"slider"},null,-1),Id={key:0,class:"label"};_e();const Ad=Rd((e,t,n,r,o,a)=>(B(),D("div",Cd,[k("label",Pd,[k("input",{id:n.id,type:"checkbox",checked:n.modelValue,onInput:t[1]||(t[1]=(...i)=>r.updateValue&&r.updateValue(...i))},null,40,["id","checked"]),Sd]),r.props.label?(B(),D("label",Id,Se(r.props.label),1)):tt("",!0)])));var Od=`
...
`;le(Nd);Qr.render=zd;Qr.__scopeId="data-v-4c24feac";var ii={props:{mode:{type:String,default:"light"}},setup(e){return{props:e}}};function Fd(e,t,n,r,o,a){return B(),D("div",{id:"app-theme",class:["theme",r.props.mode+"-theme"],ref:"theme"},[Ne(e.$slots,"default")],2)}var Ld=`
